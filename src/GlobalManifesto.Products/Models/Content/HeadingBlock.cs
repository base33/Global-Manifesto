...
namespace GlobalManifesto.Products.Models.Content
{
	...
	{
		public override string ContentTypeAlias { get { return "HeadingBlock"; } }
		...
		public HeadingBlock(string name, IConcreteModel parent)
			: this(name, parent.Id)
		{
		}

		public HeadingBlock(string name, int parentId)
			: base()
		{
			this.Name = name;
		...
		public HeadingBlock(int contentId, bool getPropertiesRecursively = false)
			: base(contentId, getPropertiesRecursively)
		{
		}

		public HeadingBlock(IPublishedContent content, bool getPropertiesRecursively = false)
